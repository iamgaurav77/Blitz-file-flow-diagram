...
@Component("PrintPdfContri")
public class PrintPdfContri  implements JavaDelegate{

	@Override
	public void execute(DelegateExecution execution) throws Exception {
		// TODO Auto-generated method stub
		 Double contriamount = (Double) execution.getVariable("contriamount");
		 ...
		 document.save("C:\\PDF\\contribution\\" + strDate +".pdf");
		 document.close();
	}
